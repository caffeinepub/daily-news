...
export class Backend implements backendInterface {
    ...
    async getFeaturedNews(): Promise<Array<Article>> {
        if (this.processError) {
            try {
    ...
    async getLatestTopStories(): Promise<Array<Article>> {
        if (this.processError) {
            try {
                const result = await this.actor.getLatestTopStories();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getPaginatedArticles(arg0: bigint, arg1: bigint): Promise<Array<Article>> {
        if (this.processError) {
            try {
                const result = await this.actor.getPaginatedArticles(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
